  ...
  function utilityPanelContent() {
    ...
    if (utilityPanel === "settings") {
      ...
      const advancedBody = `<div class="utility-settings-fields">${
        ...
        field("localModel.expectedTags", "localModel.expectedTagsHint", "expectedTags", llm.expectedTags ?? "")
      }${
