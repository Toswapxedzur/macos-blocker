...
/// An HTTP status failure from a provider call. Thrown by the research
/// execution layer, classified by Core's GroundedResearchFailureKind — so the
/// vocabulary lives here, beside the other provider errors.
