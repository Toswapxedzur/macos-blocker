...
final class ClusterRollingUsageTests: XCTestCase {
    private func linkedHub() -> ConnectionHub {
        ...
        hub.setRoster(program: "chrome", groups: [["id": "c1", "name": "Focus", "type": "site"]])
        return hub
    }
    ...
    func testSeedThenIncrementsAreSummedPerMinute() throws {
        ...
        hub.applySync(program: "chrome", groupName: "Focus", groupType: "site",
        ...
        hub.applySync(program: "macapp", groupName: "Focus", groupType: "site",
